"""Structured heuristic bot for BGLike (value model from minibg)."""
...
class StructuredHeuristicBot(HeuristicBot):
    ...
    def _pick_place(self, mask: np.ndarray, p: PlayerState, rl: int, rn: int) -> int:
        ...
        for a in actions:
            ...
            # A SpellCard (e.g. the triple-reward discover spell) has no
...
__all__ = ["StructuredHeuristicBot"]
