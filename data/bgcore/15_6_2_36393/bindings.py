...
EFFECTS: Dict[str, Tuple[Ability, ...]] = {
    ...
    "TB_BaconUps_045": (
        Ability(Trigger.AURA, Multiplier(MultiplierKind.BATTLECRY, factor=3)),
    ),
    "TB_BaconUps_055": (
        Ability(Trigger.AURA, Multiplier(MultiplierKind.DEATHRATTLE, factor=3)),
    ),
    "DAL_575": (Ability(Trigger.AURA, Multiplier(MultiplierKind.SUMMON, factor=2)),),
    "TB_BaconUps_034": (
        Ability(Trigger.AURA, Multiplier(MultiplierKind.SUMMON, factor=3)),
    ),
